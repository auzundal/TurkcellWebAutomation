...
public class MiscMethods {
     ...
     */
    public void validateLocator(String type) throws TestCaseFailed, IOException {
     ...
     */
    public void validateOptionBy(String optionBy) throws TestCaseFailed, IOException {
        if (!valid_option_by(optionBy))
            throw new TestCaseFailed("Invalid option by - " + optionBy);
    }
}
